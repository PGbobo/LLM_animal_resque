    ...
    (async () => {
      ...
      try {
        ...
        const mapped = rows.map((r) => {
          const type = r.type || "witness";
          const title = r.title || "목격 제보";

          return {
            id: r.id, // REPORT_NUM AS id
            title, // 카드 제목
            name: title, // PetListItem에서 사용할 이름
            status: "제보",
            location: r.location || "",
            time: timeAgo(r.date), // REPORT_DATE AS date
            img: r.img || "/images/placeholders/report.png", // PHOTO AS img
            latlng:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white p-4 rounded-xl shadow-lg border border-slate-200">
            <div className="w-full h-[600px] rounded-lg">
              <KakaoMap pets={witnessPosts} selectedPet={selectedPet} />
            </div>
